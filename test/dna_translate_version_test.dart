...
void main() {
  group('dna_translate_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/dna_translate_version.dart');
